...
tank_T3_0 = r"image\tank_T3_0.png"
tank_T3_1 = r"image\tank_T3_1.png"
tank_T3_2 = r"image\tank_T3_2.png"
...
class MyTank(pygame.sprite.Sprite):
    def __init__(self, playerNumber):
        ...
        if playerNumber == 3:
            self.tank_L0_image = pygame.image.load(tank_T3_0).convert_alpha()
            self.tank_L1_image = pygame.image.load(tank_T3_1).convert_alpha()
            self.tank_L2_image = pygame.image.load(tank_T3_2).convert_alpha()
        # 初始坦克为0级
        self.level = 0
